...
class HttpSupervisor(object):
    ...
    def __init__(self):
        ...
        if self._sec == True:
            ...
            http_server = tornado.httpserver.HTTPServer(application, ssl_options=dict(certfile=cert, keyfile=key, cert_reqs=ssl.CERT_NONE, ca_certs=ca))
        else:
